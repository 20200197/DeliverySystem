...
if (isset($_GET['action'])) {
    ...
    $vendedor = new AdministrarVendedor;
    ...
    switch ($_GET['action']) {
        ...
        case 'changePassword':
            ...
            break;
            /**Graficas */
        case 'readProductosMasVendidosValorados':
            if ($result['dataset'] = $vendedor->readProductosMasVendidosValorados()) {
                $result['status'] = 1;
            } elseif (Database::getException()) {
                $result['exception'] = Database::getException();
            } else {
            ...
            break;
        case 'readPorcentajeVentaCategoria':
            if ($result['dataset'] = $vendedor->readPorcentajeVentaCategoria()) {
                $result['status'] = 1;
            } elseif (Database::getException()) {
                $result['exception'] = Database::getException();
            } else {
